...
Portafolio personal de Rafael Matovelle estructurado como un **viaje horizontal en el tiempo**. El visitante hace scroll lateral y recorre 7 chapters cronológicos (1995 → 2026); en cada uno, el estilo visual del sitio, el pixel art del avatar (envejecimiento ~10 → 40 años), y el contenido destacado cambian para reflejar esa era tecnológica y el chapter correspondiente de la carrera de Rafael. Apunta primariamente a recruiters internacionales (US/EU/Canadá) y secundariamente a la comunidad gamedev / clientes potenciales para gigs.
...
**Mecánica & estructura**
- [ ] Scroll horizontal con snap suave por chapter (7 chapters)
- [ ] 7 chapters cronológicos con estilos visuales distintivos (mapeo en *Context*)
- [ ] Avatar pixel art bust que cambia por chapter (envejecimiento ~10 → 40 años)
...
**Compatibilidad**
- [ ] Desktop fluido (mouse wheel → scroll horizontal, swipe pad funcional)
- [ ] Mobile landscape funcional
- [ ] Mobile portrait: overlay "gira tu dispositivo" (no se soporta navegación en portrait)
...
- **Mobile portrait con navegación completa** — el concepto requiere ancho horizontal; mantener dos modos doblaría el scope sin aporte equivalente.
...
| 6 | 40 (2026) | **Phaser escena explorable**: sidescroller espacial con parallax, naves cruzando, planetas-proyecto | Software Mind QA + AI (convergencia) | Sí (fondos + ships + planetas + UI ambiente) |
...
- **Mobile**: landscape obligatorio; portrait bloqueado con overlay
...
| Phaser chapter 6 como escena explorable, no juego con objetivos | Sin character animation viable (pixelforge no produce frames coherentes), forzar gameplay con NPCs sería artificial. Parallax + ships + planetas-proyecto mantiene el "wow" sin ese requisito. | — Pending |
| Mobile landscape obligatorio, portrait bloqueado con overlay | Concepto requiere ancho horizontal; mantener dos modos doblaría scope sin aporte equivalente. | — Pending |
| Default landing en chapter 3 (Web 2.0 + arte digital) | Visitante ve algo pulido y "normal" al entrar; barra animada invita a moverse. Quien no toca nada igual ve un portafolio decente. | — Pending |
