...
// TASK-021 (2026-07-28) — el describe de carrera async de mountGame()
// (zombie + doble instancia) que vivía acá se movió a su propio archivo:
// tests/components/Ch2MiniGame.race.test.js. Motivo: HIGH del review de
// cierre de TASK-021 — bajo contención real de CPU (otro proceso vitest en
// paralelo, la condición NORMAL en este proyecto multi-agente) el
// `vi.doMock()` que esos specs usaban para diferir el import perdía su
// carrera de registro, y el registry envenenado arrastraba a los 6 tests
// de este archivo a un rojo en cascada — pese a que el guard de producción
// que verifican (Ch2MiniGame.vue:86) es correcto. El aislamiento por
// archivo de Vitest (module registry nuevo por worker) contiene ese blast
// radius de forma estructural, y el archivo nuevo además elimina la causa
// de raíz (ya no usa vi.doMock, ver cabecera de ese archivo). Detalle
// completo en el hand-off de TASK-021.
